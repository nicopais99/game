...
from objeto_juego3 import Objeto
from personaje_enemigo3 import *
from items3 import *
            ...
            case "Saltando":
                if not self.esta_saltando:
                    ...
                    if self.que_hace == "Derecha":
                        self.animar(pantalla, "personaje_saltando",1)
                    elif self.que_hace == "Izquierda":
                        self.animar(pantalla, "personaje_saltando_izquierda", 1)
            case "Quieto":
                if not self.esta_saltando:
