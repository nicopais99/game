...
boss = [pygame.image.load("proyecto_pygame/Boss/0.png"),
        pygame.image.load("proyecto_pygame/Boss/1.png"),
        pygame.image.load("proyecto_pygame/Boss/2.png"),
        pygame.image.load("proyecto_pygame/Boss/3.png"),
        pygame.image.load("proyecto_pygame/Boss/4.png"),
        pygame.image.load("proyecto_pygame/Boss/5.png"),
        pygame.image.load("proyecto_pygame/Boss/6.png")
        ]

diccionario_boss = {}
diccionario_boss["corriendo_derecha_enemigo"] = boss
